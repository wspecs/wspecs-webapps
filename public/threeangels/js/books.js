...
$("li.bi").each(function() {
  ...
  $this.find(".bkfr > div").css('background-color', $(this).data("color"));
  $this.find(".bklf").css('background-color', $(this).data("color"));
  $this.find(".bkc").css('background-color', $(this).data("color"));
...
bookList.prototype._handleSearchKeyup = function(evt) {
  ...
  this.shuffle.filter(function(element, shuffle) {
    ...
    var titleElement = element.querySelector('.bi_title');
